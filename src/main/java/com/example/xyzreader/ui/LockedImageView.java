...
public final class LockedImageView extends ImageView {
    ...
    public LockedImageView(Context context, AttributeSet attrs) {
        super(context, attrs);

        final TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.LockedImageView);
        aspectRatio = a.getFloat(R.styleable.LockedImageView_aspectRatio, 0);
        a.recycle();
    }
